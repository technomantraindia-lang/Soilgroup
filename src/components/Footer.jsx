...
import { Phone, Mail, Facebook, Instagram, Linkedin, Youtube, MapPin, ArrowRight } from 'lucide-react'
...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Facebook size={20} />, href: 'https://www.facebook.com/profile.php?id=61583583847742', label: 'Facebook' },
    { icon: <Instagram size={20} />, href: 'https://www.instagram.com/soilplusorganics/', label: 'Instagram' },
    { icon: <Linkedin size={20} />, href: 'https://www.linkedin.com/company/soilplusorganics', label: 'LinkedIn' },
    { icon: <Youtube size={20} />, href: 'https://www.youtube.com/@soilplusorganics', label: 'YouTube' },
  ]
          ...
          <div className="footer-brand">
            <Link to="/" className="footer-logo">
              <div className="footer-logo-wrapper">
                <img src={logo} alt="Soil+ Organics" decoding="async" loading="lazy" width={180} height={70} />
              </div>
            </Link>
